...
class PackagesWidget implements SubmoduleWidgetInterface {
	...
	public function render($widgetConfiguration) {
		...
		$view->setTemplatePathAndFilename('resource://Meteko.Submodulewidgets/Private/Templates/Widget/Packages.html');
